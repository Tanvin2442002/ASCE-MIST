...
export default function UpcomingEventsPage() {
  ...
  if (loading) {
    return <div className="text-center py-20">Loading upcoming events...</div>;
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Join our upcoming seminars, workshops, site tours and hands-on
            events organized by ASCE MIST and the Civil Engineering Department.
          </p>
        </div>
